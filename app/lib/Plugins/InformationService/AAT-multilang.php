<?php
/** ---------------------------------------------------------------------
 * app/lib/Plugins/InformationService/AAT-multilang.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
global $g_information_service_settings_AAT_multilang;
$g_information_service_settings_AAT_multilang = array();

class WLPlugInformationServiceAATmultilang extends BaseGettyLODServicePlugin implements IWLPlugInformationService {
	# ------------------------------------------------
	static $s_settings;
	# ------------------------------------------------
	...
	public function __construct() {
		global $g_information_service_settings_AAT_multilang;
		$g_information_service_settings_AAT_multilang['limitToHierarchy'] = [
			'formatType' => FT_TEXT,
		...
		$g_information_service_settings_AAT_multilang['additionalFilter'] = [
			'formatType' => FT_TEXT,
			'displayType' => DT_FIELD,
			'default' => '',
			'width' => 90, 'height' => 1,
		...
		$g_information_service_settings_AAT_multilang['sparqlSuffix'] = [
			'formatType' => FT_TEXT,
			'displayType' => DT_FIELD,
			'default' => '',
			'width' => 90, 'height' => 1,
		...
		$g_information_service_settings_AAT_multilang['orderBy'] = [
			'formatType' => FT_TEXT,
		...
		$g_information_service_settings_AAT_multilang['language'] = [
			'formatType' => FT_TEXT,
		...
		WLPlugInformationServiceAATmultilang::$s_settings = $g_information_service_settings_AAT_multilang;
		parent::__construct();
		$this->info['NAME'] = 'AAT';

		$this->description = _t( 'Provides access to multilingual Getty Linked Open Data AAT service' );
	}

	# ------------------------------------------------
	protected function getConfigName() {
		return 'aat-multilingual';
	}
	# ------------------------------------------------
	...
	public function getAvailableSettings() {
		return WLPlugInformationServiceAATmultilang::$s_settings;
	}
