<?php
/* ----------------------------------------------------------------------
 * app/plugins/libisResolverPreviewPlugin.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
	...
	class libisResolverPreviewPlugin extends BaseApplicationPlugin {
		# -------------------------------------------------------
		/**
		 *
		 */
		...
		public function __construct($ps_plugin_path) {
			...
			$this->description = _t('Preview Libis Resolver Images');
			
			parent::__construct();
			
			$this->opo_config = Configuration::load($ps_plugin_path.'/conf/libisResolverPreview.conf');

			//MetaTagManager::addScript(__CA_URL_ROOT__."/app/plugins/libisResolverPreview/themes/".__CA_THEME__."/js/vue.js",'text/javascript');
		...
		$va_menu_items['ResolverPreview'] = array(
			'displayName' => _t('Resolver Preview'),
			"default" => array(
				'module' => 'libisResolverPreview',
				'controller' => 'Preview',
				'action' => 'Index'
			)
		);
